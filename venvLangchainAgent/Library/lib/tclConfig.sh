...
# installed.
TCL_PREFIX='D:/Work/learning/GEN-ai/venvLangchainAgent\Library'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='D:/Work/learning/GEN-ai/venvLangchainAgent\Library\bin'
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='D:/Work/learning/GEN-ai/venvLangchainAgent\Library\lib\tcl86t.lib'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-ID:/Work/learning/GEN-ai/venvLangchainAgent\Library\include'
...
TCL_PACKAGE_PATH='D:/Work/learning/GEN-ai/venvLangchainAgent\Library\lib'
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-LD:/Work/learning/GEN-ai/venvLangchainAgent\Library\lib tclstub86.lib'
...
TCL_STUB_LIB_PATH='D:/Work/learning/GEN-ai/venvLangchainAgent\Library\lib\tclstub86.lib'
